...
import {
  Shield, Code2, Briefcase, Globe, Mail, Phone,
  Github, Linkedin, Twitter, Instagram, Facebook,
  ExternalLink, ChevronRight, Cpu, Lock,
} from 'lucide-react';
...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden bg-[#020b16] border-t border-white/5">
      <div className="absolute top-0 left-1/4 w-[600px] h-[300px] rounded-full bg-sky-500/4 blur-[100px] pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-[400px] h-[200px] rounded-full bg-emerald-500/4 blur-[80px] pointer-events-none" />
